...
typedef struct _STREAMBUFFER_DESCRIPTOR {
    PVOID  UserPtr;
    DWORD  (* Read)(PVOID t, UINT64 Offset, PVOID Buffer, DWORD Size, PDWORD SizeRead);
    DWORD  (* Write)(PVOID t, UINT64 Offset, PVOID Buffer, DWORD Size, PDWORD TotalWritten);
    DWORD  (* GetSize)(PVOID t, UINT64 *FileSize);
    DWORD  (* SetSize)(PVOID t, UINT64 *FileSize);
    PWCHAR (* GetName)(PVOID t);
    DWORD  (* SetAttributes)(PVOID t, DWORD Attribute, PVOID Data, DWORD DataSize);
    DWORD  (* GetAttributes)(PVOID t, DWORD Attribute, PVOID Data, DWORD DataSize, PDWORD DataSizeWritten);
